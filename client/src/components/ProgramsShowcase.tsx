                ...
                <Card className="p-6 border-2 border-l-4 border-l-primary rounded-sm">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-display text-muted-foreground italic">
                        Online gathering space where seeds of ideas are planted and exchanged. Share cultivation discoveries, ask fellow gardeners questions, and watch insights sprout in conversation.
                      </p>
                    </div>
                  </div>
                </Card>
                ...
                <Card className="p-6 border-2 border-l-4 border-l-primary rounded-sm">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-display text-muted-foreground italic">
                        Monthly book discussions, conversations on ascetic wisdom, sustainable growth, and cultivating meaningful work. Seeds of knowledge shared.
                      </p>
                    </div>
                  </div>
                </Card>
