...
export default function Hero() {
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden border-b-2 border-border">
      ...
      <div className="absolute top-8 left-8 text-primary/20 text-6xl font-serif">
        ❦
      </div>
      <div className="absolute top-8 right-8 text-primary/20 text-6xl font-serif">
        ❦
      </div>
      <div className="absolute bottom-8 left-8 text-primary/20 text-6xl font-serif">
        ✺
      </div>
      <div className="absolute bottom-8 right-8 text-primary/20 text-6xl font-serif">
        ✺
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-8 md:px-16 py-24 text-center">
        ...
        <p className="font-display text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-10 leading-loose italic">
          ...
          <br />
          Cultivate interests and relationships.
          <br />
          Partake amongst friends.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
          <ZoomLink href="/join">
            <Button
              size="lg"
              className="rounded-sm text-sm uppercase tracking-wide px-8 border-2"
          ...
          <ZoomLink href="/faq">
            <Button
              variant="outline"
              size="lg"
              className="rounded-sm text-sm uppercase tracking-wide px-8 bg-card/50 backdrop-blur-sm border-2"
